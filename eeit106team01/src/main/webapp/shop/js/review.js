        ...
        success: function (result) {
            ...
            $.each(result[0], function (key, val) {
                if (key.match(/^(image)$/) && val != null) {
                    img.push("<img id='currentImage' src='data:image/jpeg;base64," + val + "'class='img-thumbnail'>");
                    ...
                    textHead.push("<th class='" + key + "'>" + key + "</th>");
                    text.push("<td><input type='number' id='updateRating' class='form-control' value='" + val + "'></input></td>");
                } else if (key.match(/^(comment)$/)) {
                    textHead.push("<th class='" + key + "'>" + key + "</th>");
                    text.push("<td><textarea id='updateComment' class='form-control' rows='2' value='" + val + "'>" + val + "</textarea></td>");
                }
            ...
            var updateImageInput = "<input type='file' name='' class='form-control-file mt-2 mb-2' id='updateImage' placeholder='' data-target='image' accept='.png,.jpg,.jpeg'>";
            ...
            var updateButton = "<td colspan='8'><button type='button' name='' id='update' class='btn btn-secondary btn-lg btn-block'>Update</button></td>";
...
function openCardAccordion(type) {
    if (type == 'shopping-cart' && $('#accordion-shopping-cart img').attr("src") != undefined) {
        enableSlideToggle(type);
    } else if (type == 'discount' && "" != $('#accordion-discount img').attr("src") != undefined) {
        enableSlideToggle(type);
    } else if (type == 'recommended' && "" != $('#accordion-recommended img').attr("src") != undefined) {
        enableSlideToggle(type);
    } else if (type == 'customer-service' && "" != $('#accordion-customer-service img').attr("src") != undefined) {
        enableSlideToggle(type);
    }
};
...
$('#card-shopping-cart').mouseover(function () {
    $('#card-shopping-cart .card-img-top').attr("class", "card-img-top mr-1 mouseover");
});
...
$('#card-discount').mouseover(function () {
    $('#card-discount .card-img-top').attr("class", "card-img-top mr-1 mouseover");
});
...
$('#card-recommended').mouseover(function () {
    $('#card-recommended .card-img-top').attr("class", "card-img-top mr-1 mouseover");
});
...
$('#card-customer-service').mouseover(function () {
    $('#card-customer-service .card-img-top').attr("class", "card-img-top mr-1 mouseover");
});
...
function addToCart() {
    ...
    $('#shoppingCartButton').click(function () {
        ...
        var productId = parseInt(productURL.substr(productURL.indexOf('?') + 1, productURL.length));
        var productName = $('#productName').text();
        var productPrice = parseInt($('#productPrice').text().substr($('#productPrice').text().indexOf('$') + 1, $('#productPrice').text().length));
