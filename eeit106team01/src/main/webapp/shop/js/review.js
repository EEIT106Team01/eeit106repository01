...
function findReviewsByProductId(idType, id) {
    ...
    let data = { idType: `product`, id: id };
    let url = urlDomain + resource;
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            reviewsJson.forEach(review => {
                ...
                generateReview(url, productPageUrl, reviewId, comment, updateTime, rating, image, productId, productName, purchaseListId, purchaseListSerialNumber, memberId);
            });
        }
    });
}
...
// New Review
function generateReview(url, productPageUrl, reviewId, comment, updateTime, rating, image, productId, productName, purchaseListId, purchaseListSerialNumber, memberId) {
    $(`<li> 
          ...
          <div class="comment-details"> 
            ...
            <div class="comment-head"> 
              ...
              <div class="comment-footer"> 
                ...
                <div class="action-links"> <a href="javascript:;" onclick="jQuery('#modal-edit-comment').modal('show');" class="edit"><i class="entypo-pencil"></i>編輯</a> 
              </div> 
            </div> 
          </div> 
