...
/**
 * Support video type : All the ffmpeg supported encode type, see https://www.ffmpeg.org/general.html#File-Formats
 * 
 * @author Chiayen
 *
 */
public class FFmpegUtils {
	...
	/**
	 * Use default fields of FFmpegPath and FFprobePath written in this class for FFmpeg and FFprobe. 
	 * @throws IOException
	 */
	...
	/**
	 * This method generates short cut from input video file.<br>
	 * If input video longer then thirty seconds, this method will cut four parts from input video, 
	 * then merge these parts into output gif file. <br>
	 ...
	 * @param height 1080 for 1920x1080, 720 for 1280x720, 480 for 854x480, other value for nothing.
	 */
	...
	/**
	 * This method convert video to video file with specific format, resolution, bitrate and frames per second.
	 * @param inFile Input video file.
	 ...
	 */
	private void convertVideo(File inFile, File outFile, String outputFormat, int width, int height, long bitrate, int fps) {
		FFmpegBuilder builder = new FFmpegBuilder().
				setInput(inFile.getAbsolutePath()).
				overrideOutputFiles(true).
				addOutput(outFile.getAbsolutePath()).
...
//		File outFile = new File("C:/JAVA/baseball720.mp4");
...
////		ffu.generateThumbnail(inFile, outFileJpg, -1);
////		ffu.generateDefaultGifCut(inFile, outFileGif);
//		ffu.convertVideoToMp4(inFile, outFile, 720);
//	}
